 ...
 * @author omran
 */
public class FrontHomeEvenementController implements Initializable {
    ...
    private void refreshNodes()
    {
       ...
       // Node [] nodes = new  Node[Evenements.size()];
        ...
        {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("FrontItemEvenement.fxml"));
                Node node = (Node) loader.load();
                FrontItemEvenementController controller = loader.getController();
