...
@FXML
   ...
   @FXML
    ...
    @FXML
    private Button jibelpbtn;
    @FXML
    private Button jibelabtn;
    @FXML
...
//hadhy ta3 profile generale
    ...
    public void info() throws SQLException {
        ...
        if (rs.next()) {
            ...
            Image img1 = new Image("file:C:\\Users\\yassine\\Desktop\\9raya\\Pidev\\PidevJava-Shop\\src\\pidev\\gargabou\\gui\\images\\green_eco_loop_leaf_check_mark.jpg");
             Image img2 = new Image("file:C:\\Users\\yassine\\Desktop\\9raya\\Pidev\\PidevJava-Shop\\src\\pidev\\gargabou\\gui\\images\\reliabilty.png");
            ...
            Image img = new Image("file:C:/Users/yassine/Desktop/9raya/Pidev/ProjIng/public/uploads/"+rs.getString("image"), true);
