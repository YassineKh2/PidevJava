...
public class PublicationItemController implements Initializable {
    ...
    @FXML
    private MenuItem btnModifierPub;
    ...
    public void setPublication(Publication pub) throws SQLException {
        ...
        for(User us:user){
            ...
            if(userNow.getid()!=pub.getIdUser()){
                ...
                btnModifierPub.setVisible(false);
            }
        }
...
//    }
    ...
    private void downloadPdf(ActionEvent event) throws FileNotFoundException, DocumentException, SQLException, BadElementException, IOException {
        ...
        try {
            ...
            canvas.stroke();
            //
            com.itextpdf.text.Image image = com.itextpdf.text.Image.getInstance(new File("C:/Users/yassine/Downloads/pdf/" + pub.getImageForum()).getAbsolutePath());
