...
public class ActiviteCentre {
    ...
    public ActiviteCentre(String JourActivite, String NomActivite, String ContenuActivite, Date HeureDebutActivite, Date HeureFinActivite, int NombreParticipantActiviteMax) {
    ...
    public ActiviteCentre(int id, String JourActivite, String NomActivite, String ContenuActivite, Date HeureDebutActivite, Date HeureFinActivite, int NombreParticipantActiviteMax) {
        this.id = id;
        this.JourActivite = JourActivite;
        this.NomActivite = NomActivite;
        this.ContenuActivite = ContenuActivite;
